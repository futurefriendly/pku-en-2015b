...
module.exports = function (grunt) {
    ...
    cssmin: {
      ...
      core: {
        files: {
          ...
          'dist/css/<%= pkg.name %>-custom.min.css': 'dist/css/<%= pkg.name %>-custom.css'
        }
      },
      docs: {
        src: [
      ...
      compile: {
        options: {
          ...
          data: function () {
            ...
            var fileContentconcat = fs.readFileSync(filePath, { encoding: 'utf8' });
  ...
  // PKU customize task.
  grunt.registerTask('pku', ['includereplace', 'less-compile', 'dist-css', 'dist-js']);
